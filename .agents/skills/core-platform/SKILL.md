---
name: core-platform
description: Use when changing Clash Arc Core integration, lifecycle/process ownership, Go event delivery, Android services, desktop IPC, platform managers, VPN/TUN, or Windows Helper flow.
---
