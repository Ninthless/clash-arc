---
name: localization
description: Use when changing Clash Arc UI text, scanning for hardcoded Chinese strings, updating ARB localization, or fixing generated locale output in this repository.
---
...
Use this for localization work inside `/Users/Shared/follow/Clash Arc`, especially hardcoded UI text in `lib/`, ARB updates, missing translations, or generated `lib/l10n/` output that does not match source ARB values.
