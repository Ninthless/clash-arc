---
name: provider-tests
description: Use when adding or updating Clash Arc Riverpod provider tests, notifier tests, or state-management tests in this repository.
---
...
- Do not use `dart test`; Clash Arc models and provider tests may depend on Flutter types.
